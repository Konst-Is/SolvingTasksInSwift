...
Как перемножить две квадратные матрицы: Нам даны две матрицы, A и B, размером 2x2 (примечание: тесты не ограничиваются 2x2). 
Матрица C, решение, будет равна произведению A и B. Чтобы заполнить ячейку [0][0] матрицы C, нужно вычислить: A[0][0] * B[0][0] + A[0][1] * B[1][0].
Более общий вариант: Чтобы заполнить ячейку [n][m] матрицы C, нужно сначала умножить элементы n-й строки матрицы A на элементы m-го столбца матрицы B, 
